using Loopscale.Authentication.API.Filters;
using Loopscale.Authentication.API.Infrastructure;
using Loopscale.Authentication.API.Providers;
...
[assembly: OwinStartup(typeof(Loopscale.Authentication.API.Startup))]
